$(function () {
                        ...
                        [
                            {
                                ...
                                action: function (data) {
                                    window.location.href = "/dekanlik/Onayla/" + data.record.id;
                                }
                            }
                        ]
                },
    ...
    var dataTable = $("#OgrenciStajBasvurususTable").DataTable(abp.libs.datatables.normalizeConfiguration({
        ...
        scrollCollapse: true,
        order: [[1, "asc"]],
        ajax: abp.libs.datatables.createAjax(ogrenciStajBasvurusuService.getListDekanlikOnayBekleyenler, getFilter),
